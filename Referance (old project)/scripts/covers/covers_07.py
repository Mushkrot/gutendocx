...
if "--config" not in sys.argv:
    # Запускаем тот же исполняемый файл с флагом "--config"
    subprocess.run([sys.executable, "--config"], creationflags=subprocess.CREATE_NEW_CONSOLE)
