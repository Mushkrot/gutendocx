...
BACKGROUND_IMAGE_PATH = None  # Will be set later
LOGO_PATH = None              # Will be set later
LOGO_SIZE = (400, 200)        # Logo size in pixels
...
# Extract dynamic layout parameters from config
ZONE_COUNT = 4
...
BACKGROUND_COLOR = (108, 37, 36)  # RGB background color
...
def create_image(data, output_path):
    try:
        ...
        # Zone 4: Reserved for logo or other elements
